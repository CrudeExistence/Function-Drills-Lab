...
let nameGreeting = nameCheck("Dudett the intelligent")
...
let colorRating = faveColorFinder("bestColor")
...
function printAllNames(supDud) {
  for (i = 0; i < supDud.length-1; i++) {
    console.log(supDud[i])
  }
}
